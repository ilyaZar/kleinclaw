...
export const CONDITION_TRIGGER_XPATH =
  "//label[contains(@for, '.condition')]/following::button" +
  "[@aria-haspopup='dialog' or @aria-haspopup='true'][1]";
export const CATEGORY_CHANGE_CONTROL_XPATH =
  "//a[contains(., 'Kategorie')] | //button[contains(., 'Kategorie')]";
export const CATEGORY_NEXT_BUTTON_XPATH = "//button[contains(., 'Weiter')]";
export const CATEGORY_PICKER_RADIO_SELECTOR =
...
export const SHIPPING_OTHER_METHODS_BUTTON_XPATH =
...
export const SHIPPING_DIALOG_DONE_BUTTON_XPATH =
  `${SHIPPING_DIALOG_XPATH}//button[contains(., "Fertig")]`;
export const SHIPPING_DIALOG_NEXT_BUTTON_XPATH =
  `${SHIPPING_DIALOG_XPATH}//button[contains(., "Weiter")]`;
...
export const TRACKING_SCRIPT_TEXT_JS =
  "[...document.querySelectorAll('script')].map(s => s.textContent).join('\\n')";
export const CONDITION_GERMAN_TO_API: Record<string, string> = {
  neu: "new",
  wie_neu: "like_new",
  sehr_gut: "like_new",
  gut: "ok",
