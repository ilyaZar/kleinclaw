...
export declare function buildBrowserSessionPlan(configOrBrowserConfig: Config | BrowserConfig, { debugLogging, homeDir, cwd, }?: BrowserSessionPlanOptions): BrowserSessionPlan;
